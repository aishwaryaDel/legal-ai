...
export class UserRoleController {
  ...
  async getRolesByUserId(req: Request, res: Response): Promise<void> {
    try {
      ...
      const userRoles = await userRoleService.getRolesByUserId(userId, includeInactive);
  ...
  async getUsersByRoleId(req: Request, res: Response): Promise<void> {
    try {
      ...
      const userRoles = await userRoleService.getUsersByRoleId(roleId, includeInactive);
  ...
  async removeRoleFromUser(req: Request, res: Response): Promise<void> {
    try {
      ...
      const success = await userRoleService.removeRoleFromUser(userId, roleId, soft);
  ...
  async deleteUserRole(req: Request, res: Response): Promise<void> {
    try {
      ...
      await userRoleService.deleteUserRole(id, soft);
